...
const root='D:/life'; const types={'.html':'text/html','.mp4':'video/mp4','.jpg':'image/jpeg','.png':'image/png','.js':'text/javascript','.css':'text/css','.webp':'image/webp','.svg':'image/svg+xml','.ico':'image/x-icon'};
...
}).listen(+process.env.PORT||3000,()=>console.log("serving D:/life on http://localhost:"+(+process.env.PORT||3000)));
